...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
        <div>
            <h1 class="h2 fw-bold mb-1">{{ __('Control de Acceso (ACL): Roles y Permisos') }}</h1>
                ...
                <tbody>
                    @forelse ($roles as $role)
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-secondary font-monospace">{{ $role->slug }}</span>
                            </td>
                            ...
                            <td class="text-center">
                                @if ($role->isSystem() || in_array($role->slug, ['admin', 'client']))
                                    <span class="badge bg-warning text-dark">{{ __('Sistema') }}</span>
                                @else
                                    <span class="badge bg-light border text-dark">{{ __('Personalizado') }}</span>
                                @endif
                            </td>
                            <td class="text-end">
