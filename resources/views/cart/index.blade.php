...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 fw-bold text-dark mb-1">{{ __('Carrito de Compras') }}</h1>
    ...
    @if ($cart->items->isEmpty())
        <div class="card shadow-sm border-0 text-center py-5">
            <div class="card-body">
                ...
                <h4 class="fw-bold text-dark mb-2">{{ __('Tu carrito está vacío') }}</h4>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-end" style="width: 130px;">{{ __('Subtotal') }}</th>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-bold">{{ $cart->getTotalQuantity() }}</span>
                        </div>
                        ...
                        <hr>
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <span class="h5 fw-bold text-dark mb-0">{{ __('Total:') }}</span>
                            <span class="h4 fw-bold text-primary mb-0">
                                ${{ number_format($cart->total_amount, 2, ',', '.') }}
                            </span>
                        </div>

                        <a href="{{ route('cart.checkout') }}" class="btn btn-success w-100 btn-lg fw-bold shadow-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-check2-circle me-1" viewBox="0 0 16 16">
                ...
                <div class="card border-0 bg-light shadow-sm">
                    <div class="card-body p-3 small text-muted">
                        <div class="d-flex align-items-center mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-check text-success me-2" viewBox="0 0 16 16">
