...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 fw-bold text-dark mb-1">{{ __('Resumen y Confirmación de la Orden') }}</h1>
        ...
        <div class="col-lg-7 mb-4">
            <div class="card shadow-sm border-0 mb-4">
                            ...
                            <li class="list-group-item py-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('cart.items.update', $item->id) }}" method="POST" class="d-flex align-items-center">
                                        ...
                                        <label class="small text-muted me-2 mb-0">{{ __('Cantidad:') }}</label>
                                        <input type="number" 
                                               name="quantity" 
                                               value="{{ $item->quantity }}" 
                                               min="1" 
                ...
                <div class="card-footer bg-light d-flex justify-content-between align-items-center py-3">
                    <span class="h5 fw-bold mb-0">{{ __('Total a Pagar:') }}</span>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <form action="{{ route('cart.checkout.confirm') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="customer_name" class="fw-bold small text-secondary">
                        ...
                        <div class="mb-3">
                            <label for="customer_email" class="fw-bold small text-secondary">
                        ...
                        <div class="mb-3">
                            <label for="customer_phone" class="fw-bold small text-secondary">
                                {{ __('Teléfono / Celular') }}
                            </label>
                            <input type="text" 
                        ...
                        <div class="mb-4">
                            <label for="customer_address" class="fw-bold small text-secondary">
